...
[Flags]
public enum Lg2RepositoryOpenFlags : uint
{
    LG2_REPOSITORY_OPEN_NO_SEARCH = git_repository_open_flag_t.GIT_REPOSITORY_OPEN_NO_SEARCH,
    LG2_REPOSITORY_OPEN_CROSS_FS = git_repository_open_flag_t.GIT_REPOSITORY_OPEN_CROSS_FS,
    LG2_REPOSITORY_OPEN_BARE = git_repository_open_flag_t.GIT_REPOSITORY_OPEN_BARE,
    LG2_REPOSITORY_OPEN_NO_DOTGIT = git_repository_open_flag_t.GIT_REPOSITORY_OPEN_NO_DOTGIT,
    LG2_REPOSITORY_OPEN_FROM_ENV = git_repository_open_flag_t.GIT_REPOSITORY_OPEN_FROM_ENV,
}

[Flags]
public enum Lg2StatusFlags : uint
{
    LG2_STATUS_CURRENT = git_status_t.GIT_STATUS_CURRENT,
    LG2_STATUS_INDEX_NEW = git_status_t.GIT_STATUS_INDEX_NEW,
    LG2_STATUS_INDEX_MODIFIED = git_status_t.GIT_STATUS_INDEX_MODIFIED,
    LG2_STATUS_INDEX_DELETED = git_status_t.GIT_STATUS_INDEX_DELETED,
    LG2_STATUS_INDEX_RENAMED = git_status_t.GIT_STATUS_INDEX_RENAMED,
    LG2_STATUS_INDEX_TYPECHANGE = git_status_t.GIT_STATUS_INDEX_TYPECHANGE,
    LG2_STATUS_WT_NEW = git_status_t.GIT_STATUS_WT_NEW,
    LG2_STATUS_WT_MODIFIED = git_status_t.GIT_STATUS_WT_MODIFIED,
    LG2_STATUS_WT_DELETED = git_status_t.GIT_STATUS_WT_DELETED,
    LG2_STATUS_WT_TYPECHANGE = git_status_t.GIT_STATUS_WT_TYPECHANGE,
    LG2_STATUS_WT_RENAMED = git_status_t.GIT_STATUS_WT_RENAMED,
    LG2_STATUS_WT_UNREADABLE = git_status_t.GIT_STATUS_WT_UNREADABLE,
    LG2_STATUS_IGNORED = git_status_t.GIT_STATUS_IGNORED,
...
public enum Lg2IndexStage
{
    ...
    LG2_INDEX_STAGE_ANCESTOR = git_index_stage_t.GIT_INDEX_STAGE_ANCESTOR,
