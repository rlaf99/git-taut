namespace Lg2.Native
{
    public unsafe partial struct git_config_iterator
    {
        ...
        [NativeTypeName("int (*)(git_config_entry **, git_config_iterator *) __attribute__((cdecl))")]
        public delegate* unmanaged[Cdecl]<git_config_entry**, git_config_iterator*, int> next;
